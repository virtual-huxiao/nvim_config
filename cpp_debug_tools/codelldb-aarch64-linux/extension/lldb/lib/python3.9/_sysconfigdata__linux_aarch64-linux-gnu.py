...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/usr/bin/aarch64-linux-gnu-gcc -shared -L/tools/deps/lib',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                "'--enable-shared' 'ac_cv_buggy_getaddrinfo=no' "
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'gcc -shared',
 'LDFLAGS': '-L/tools/deps/lib',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.9.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/bin/aarch64-linux-gnu-gcc -shared -L/tools/deps/lib',
 'LDVERSION': '3.9',
 'LIBC': '',
 ...
 'LIBPL': '/install/lib/python3.9/config-3.9-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LOCALMODLIBS': '-L/install/lib -lz         -lbz2  -lcrypt  -L/tools/deps/lib '
                 ...
                 '-ldb    -L/tools/deps/lib -lgdbm  -L/tools/deps/lib -lssl '
 ...
 'MODLIBS': '-L/install/lib -lz         -lbz2  -lcrypt  -L/tools/deps/lib '
            ...
            '-lgdbm  -L/tools/deps/lib -lssl -lcrypto    -L/tools/deps/lib '
            '-llzma    -lrt   -L/tools/deps/lib -lsqlite3  -lssl -lcrypto      '
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.9.4 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.9.4/`cat pybuilddir.txt`:)./Lib '
